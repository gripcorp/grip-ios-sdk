Pod::Spec.new do |s|
  ...
  s.source            = {
    :http => 'https://github.com/gripcorp/grip-ios-sdk/releases/download/1.0.13/GripFramework.xcframework.zip',
    :sha256 => 'f7badf36e2b0e11b3b83242a8413d34129a1b6e75d0e5d2e6aaed91c10d3343f'
  }
