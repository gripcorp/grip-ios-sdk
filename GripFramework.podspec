Pod::Spec.new do |s|
  ...
  s.source            = {
    :http => 'https://github.com/gripcorp/grip-ios-sdk/releases/download/1.0.4/GripFramework.xcframework.zip',
    :sha256 => 'a0a037db8688c46f1d914d2e9e1d8eddca55124e833d6fa2ee8b5a3aa47612f7'
  }
