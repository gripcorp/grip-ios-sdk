Pod::Spec.new do |s|
  ...
  s.source            = {
    :http => 'https://github.com/gripcorp/grip-ios-sdk/releases/download/1.0.0/GripFramework.xcframework.zip',
    :sha256 => '17e51ecb0cddeb5b3b2bd3f1c6f1f9a47742a74b2622da81b5c90bd578b8b9e3'
  }
